...
Check out [FRONTEND LIVE DEMO](https://hunger-captian-frontend.herokuapp.com/) here!!

Check out [API LIVE DEMO](https://hunger-captian-backend.herokuapp.com/) here!!
...
```
git clone https://github.com/Jabran19/Hunger-captain.git
```
